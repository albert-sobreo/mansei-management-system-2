...
class MerchandiseInventory(models.Model):
    ...
    vol = models.DecimalField(max_digits=20, decimal_places=9, null=True, blank=True)
...
class ManufacturingInventory(models.Model):
    ...
    purchasingPrice =  models.DecimalField(max_digits=20, decimal_places=5)
    sellingPrice =  models.DecimalField(max_digits=20, decimal_places=5)
    qtyT = models.IntegerField(default=Decimal(0))
    qtyR = models.IntegerField(default=Decimal(0))
    qtyA = models.IntegerField(default=Decimal(0))
